...
export default function ContactListPage() {
    ...
    const fetchContacts = () => {
      try {
        ...
        onValue(contactsRef, (snapshot) => {
          ...
          if (data) {
            const contactList = Object.entries(data).map(([id, contact]) => ({
              id,
              ...contact,
            }));
  ...
  return (
    <div className="min-h-screen bg-black text-purple-100 p-6">
      <h2 className="text-2xl font-bold mb-6 text-purple-400">Contact List</h2>
      ...
      <div className="space-y-4">
        {filteredContacts.length === 0 ? (
          <p className="text-purple-300">No contacts found.</p>
        ) : (
          filteredContacts.map((contact) => (
            ...
            >
              ...
              <div className="flex-1">
                ...
                <p className="text-sm text-purple-400">{contact.subject}</p>
              </div>
              <a
